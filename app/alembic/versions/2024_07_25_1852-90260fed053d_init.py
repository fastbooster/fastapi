...
Revision ID: 90260fed053d
Revises: 
Create Date: 2024-07-25 18:52:05.221907
...
def upgrade() -> None:
    ...
    op.create_table('cms_ad',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False, comment='ID'),
    sa.Column('space_id', sa.Integer(), nullable=False, comment='广告位ID'),
    sa.Column('position', sa.String(length=255), server_default='left', nullable=False, comment='位置:left|right|center'),
    ...
    sa.Column('content', sa.String(length=600), nullable=True, comment='详细内容'),
    ...
    sa.Column('status', sa.SmallInteger(), server_default='1', nullable=True, comment='状态:0关闭，1开启'),
